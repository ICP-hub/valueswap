# dfx canister call cketh icrc1_transfer ' (record {to=record {owner = principal "rgtib-ktq4g-rjiya-aishg-mv2om-ey54m-jhyut-2tuaf-tvjyz-ml54r-lae"; subaccount=null}; fee=null; memo=null; from_subaccount=null; created_at_time=null; amount=500000000})'

<<<<<<< HEAD
dfx canister call LP_ledger_canister icrc1_transfer ' (record {to=record {owner = principal "fm5wa-dkllv-d7h4z-uaukh-z5aqz-ck4hr-5oaxi-7m6hy-hxkgc-rufr3-xqe"; subaccount=null}; fee=null; memo=null; from_subaccount=null; created_at_time=null; amount=500000000})'
#
# dfx canister call LP_ledger_canister icrc1_balance_of "(record {owner=principal\"bkyz2-fmaaa-aaaaa-qaaaq-cai\"; subaccount=null; memo=null; from_subaccount=null; created_at_time=null; amount=500000000})"
...
>>>>>>> 927a5dc (Minter architecture for LP)
=======
...
>>>>>>> ac36fcf (Corrected calculation for LP)
