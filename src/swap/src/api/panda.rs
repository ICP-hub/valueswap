...
#[derive(CandidType, Deserialize)]
pub struct BlockRange { pub blocks: Vec<Box<Value>> }
...
#[derive(CandidType, Deserialize)]
pub struct BlockWithId { pub id: candid::Nat, pub block: Box<Icrc3Value> }
...
impl Service {
  ...
  pub async fn get_transactions(&self, arg0: GetBlocksRequest) -> Result<
  ...
  pub async fn icrc_3_get_archives(&self, arg0: GetArchivesArgs) -> Result<
    (Vec<Icrc3ArchiveInfo>,)
  > { ic_cdk::call(self.0, "icrc3_get_archives", (arg0,)).await }
  pub async fn icrc_3_get_blocks(&self, arg0: Vec<GetBlocksRequest>) -> Result<
    (GetBlocksResult,)
