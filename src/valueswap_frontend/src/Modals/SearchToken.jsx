...
const SearchToken = ({ setSearchToken, setPayToken, setRecToken, id, setTokenData }) => {
  ...
  return (
    <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-screen h-screen overflow-y-auto text-[#FFFFFF] flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm !z-[999]">
