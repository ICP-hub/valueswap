...
import { Settings as SettingsIcon, Cached as CachedIcon } from "@mui/icons-material";
...
const Swap = () => {
    ...
    return (
        <section className="h-screen relative flex flex-col gap-y-12 bg-background-gradient">
            ...
            <div className="relative">
                        ...
                        <BorderGradientButton customCss={`bg-gray-700 z-10`}>
                            ...
                            >
                                {receiveCoin ?
                                    ...
                                    <div className="flex items-center gap-x-2">
                                        <img src={receiveCoin.ImagePath} alt="" className="w-6 h-6" />
                ...
                {/* Swap Button */}
                <div className="absolute top-[38%] left-1/2 flex items-center justify-center p-2 cursor-pointer border border-[#FFFFFF66] rounded-xl bg-gray-700 bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-20"
