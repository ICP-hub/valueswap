...
const Swap = () => {
    ...
    return (
        //         <div className='px-4 md:px-0 h-screen'>
            ...
            <div>
                <div className='w-[64%] sm:w-[480px] mb-2 mx-auto  text-[#A3A3A3] w-full bg-gray-700  bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-20 border border-gray-100 border-[#FFFFFF66] rounded-2xl p-8'>
                    ...
                    <div className='flex justify-between mt-2'>
                        <div>$0</div>
                        <div>
                            <button className='font-gilroy ml-1 sm:ml-2 text-orange-400 text-base font-normal' onClick={() => {
                                setCoinAmount(parseFloat(payCoinBalance));
                            }}>
                                {payCoinBalance !== null ? <div>
                                    {parseFloat(payCoinBalance)} {SwapModalData.PaySection.Max}
                                </div> : ""}
                            </button>
