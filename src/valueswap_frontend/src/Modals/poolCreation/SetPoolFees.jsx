    ...
    return (
        <div className=''>
            ...
            <div className='z-50 w-min md:w-max m-auto flex flex-col items-start gap-4 p-4 sm:p-6 border mx-auto rounded-xl backdrop-blur-[32px]'>
                ...
                <div
                    className={`font-gilroy text-base font-medium flex items-center justify-center`}
                    onClick={() => {
                ...
                >
                    <GradientButton CustomCss={`my-4 md:min-w-[650px] ${ButtonActive ? ' opacity-100 cursor-pointer' : 'opacity-50 cursor-default'}`}>
                        Next
                    </GradientButton>
                </div>
        </div>
