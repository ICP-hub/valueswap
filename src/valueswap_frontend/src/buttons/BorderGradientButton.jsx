...
const BorderGradientButton = ({ customCss, children }) => {
    return (
        ...
        //     <button className="rounded-[calc(0.6rem-1px)] w-full h-full       text-white font-gilroy font-[700] text-base">
        //         {children}
        //     </button>
        // </div>
        // <button className={` ${customCss} h-[45px] w-[120px] button-gradient-wrapper text-white  text-base font-gilroy rounded-lg py-4 px-[1.875rem] hover:opacity-50`}>
